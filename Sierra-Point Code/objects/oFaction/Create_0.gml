...
obj_info[OBJ_NAME.SITE_HQ].capacity.supplies				= 100;
obj_info[OBJ_NAME.SITE_HQ].capacity.cm						= 20;
obj_info[OBJ_NAME.SITE_HQ].capacity.food					= 20;
obj_info[OBJ_NAME.SITE_HQ].capacity.people					= 15;
obj_info[OBJ_NAME.SITE_HQ].resource_per_minute.supplies		= 30;

obj_info[OBJ_NAME.SITE_CAP_SUPPLIES].cost.supplies			= -15;
obj_info[OBJ_NAME.SITE_CAP_SUPPLIES].capacity.supplies		= 200;
obj_info[OBJ_NAME.SITE_CAP_SUPPLIES].capacity.cm			= 75;

obj_info[OBJ_NAME.SITE_PRO_SUPPLIES].cost.supplies			= -50;
obj_info[OBJ_NAME.SITE_PRO_SUPPLIES].resource_per_minute.supplies = 30;
obj_info[OBJ_NAME.SITE_PRO_SUPPLIES].capacity.supplies		= 50;

obj_info[OBJ_NAME.SITE_PRO_CM].cost.supplies				= -75;
obj_info[OBJ_NAME.SITE_PRO_CM].resource_per_minute.cm		= 20;
obj_info[OBJ_NAME.SITE_PRO_CM].capacity.cm					= 20;
...
obj_info[OBJ_NAME.SITE_PRO_FOOD].capacity.food				= 75;
...
obj_info[OBJ_NAME.SITE_PRO_WEAPONS].capacity.weapons		= 30;
